...
export const tlc = (str: string | undefined | null) => str?.toLowerCase?.();
...
export function findRouteNameFromNavigatorState(routes: Record<string, unknown>[]) {
...
export const toLowerCaseEquals = (a: string | undefined | null, b: string | undefined | null) => {
  if (!a && !b) return false;
  return tlc(a) === tlc(b);
};
