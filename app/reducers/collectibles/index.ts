...
const favoritesSelector = (state: { collectibles: { favorites: Record<string, Record<string, Array<{ tokenId: string; address: string }>>> } }) => state.collectibles.favorites;

export const isNftFetchingProgressSelector = (state: { collectibles: { isNftFetchingProgress: boolean } }) =>
...
const getFavoritesCollectibles = (
  favoriteCollectibles: Record<string, Record<string, Array<{ tokenId: string; address: string }>>>,
...
const collectiblesFavoritesReducer = (state = initialState, action: { type: string; selectedAddress?: string; chainId?: string; collectible?: { tokenId: string; address: string }; [key: string]: unknown }) => {
  switch (action.type) {
