...
const enqueue = (notifications: unknown[], notification: unknown) => [
  ...notifications,
  notification,
];
const dequeue = (notifications: unknown[]) => notifications.slice(1);
...
const notificationReducer = (state = initialState, action: { type: string; [key: string]: unknown }) => {
